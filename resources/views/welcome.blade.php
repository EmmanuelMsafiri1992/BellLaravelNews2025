...
<body>
    ...
    <input type="hidden" id="currentUserFeaturesActivatedInput" value="{{ Auth::user()->features_activated ? 'true' : 'false' }}">
    @endauth
    <div id="loginPage" class="login-container">
        ...
        <div class="login-card">
            ...
            {{-- Login Form --}}
            <form id="loginForm" onsubmit="return false;" class="space-y-6">
                @csrf
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2" for="password_login">Password</label>
                    <input type="password" name="password" id="password_login" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter your password" required autofocus>
                </div>
                <button type="button" class="w-full btn btn-primary py-3 text-base" id="loginBtn">
                    ...
                    <div class="card p-8 fade-in">
                        ...
                        <form id="uploadForm" class="mb-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <button type="button" class="btn btn-primary w-full" id="uploadSoundBtn">
