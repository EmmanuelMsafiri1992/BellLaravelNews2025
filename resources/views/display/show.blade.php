...
<head>
    ...
    <title>{{ $screen->name }} - {{ $settings['app_name'] ?? 'School News' }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <h1>{{ $settings['header_title'] ?? 'Welcome' }}</h1>
    ...
    <div class="main-container">
        ...
        @else
            <div style="text-align: center; padding: 100px;">
                <h2 style="color: #6b7280; font-size: 32px;">No news available for this screen</h2>
                <p style="color: #9ca3af; font-size: 18px; margin-top: 16px;">Screen: {{ $screen->name }}</p>
                @if($screen->location)
                    <p style="color: #9ca3af; font-size: 16px;">Location: {{ $screen->location }}</p>
                @endif
            </div>
        @endif
    </div>
    ...
    <div class="footer">
        <div class="footer-content">
            ...
            <div>{{ $screen->name }}{{ $screen->location ? ' - ' . $screen->location : '' }}</div>
            <div>
    ...
    <script>
        ...
        // Auto-refresh every 5 minutes to get updated news
        setTimeout(function() {
