...
<body>
                                    ...
                                    <div class="card p-3">
                                        ...
                                        @php
                                            ...
                                            if ($userLicense && $userLicense->is_used && $userLicense->expires_at) {
                                                if ($userLicense->expires_at->copy()->endOfDay()->isFuture()) {
                                                    $status = 'Active';
                                        ...
                                        @if (
                                            !$userLicense ||
                                                !$userLicense->is_used ||
                                                ($userLicense && $userLicense->expires_at && $userLicense->expires_at->copy()->endOfDay()->isPast()))
    ...
    <script>
        ...
        function toggleStaticFields() {
            ...
            // Check if elements exist (they may not be on the current tab)
            if (!staticIpRadio || !staticIpFields) {
                return;
            }
