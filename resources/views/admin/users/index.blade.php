                                    ...
                                    @forelse ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($user->license && $user->license->is_used && $user->license->expires_at && $user->license->expires_at->copy()->endOfDay()->isFuture())
                                                    <span class="badge bg-success">Active</span>
                                                @elseif ($user->license && $user->license->is_used && $user->license->expires_at && $user->license->expires_at->copy()->endOfDay()->isPast())
