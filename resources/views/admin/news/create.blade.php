...
<body>
                            ...
                            <div class="card-body">
                                <form id="news-form" action="{{ route('admin.news.store') }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="title" name="title" rows="3">{{ old('title') }}</textarea>
    ...
    <script>
        ...
        // updateCharacterCounter function removed - not needed without TinyMCE
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                editor.on('change keyup', function() {
                    // Remove validation errors when content changes
                    ...
                    fetch(newsForm.action, {
                        ...
                        .catch(error => {
                            ...
                            if (error.validation && error.errors) {
                                ...
                                showAlert('danger', `Failed to save news article: ${error.message || 'Unknown error'}`);
                            }
                        });
                });
            }
