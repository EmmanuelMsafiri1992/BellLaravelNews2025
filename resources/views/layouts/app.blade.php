...
<body class="bg-white font-inter antialiased min-h-screen flex flex-col">
    ...
    @if ($loadVueApp)
        ...
        <script>
            (function() {
                // Detect if this is a TV browser
                ...
                // Only apply timeout check for TV browsers
                if (isTVBrowser) {
                    // Add a timeout to detect if Vue app fails to load on TV
        ...
        @if (file_exists(public_path('build/manifest.json')))
            ...
            @endif
        @else
            {{-- Fallback to loading assets from public directory directly --}}
