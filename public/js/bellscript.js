                ...
                if (response.redirected) {
                    ...
                    try {
                        ...
                        if (!messageDisplayed) {
                            ...
                            showFlashMessage("Login failed. Please check your password.", "error", 'loginFlashContainer', false); // Keep this persistent
                        }
                    ...
                    if (isJson) {
                        if (result.success === true) {
                            ...
                            console.log("Login: Full result object:", JSON.stringify(result, null, 2));
