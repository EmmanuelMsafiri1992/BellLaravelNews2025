...
class User extends Authenticatable
{
    ...
    public function hasActiveLicense()
    {
        ...
        // 3. The 'expires_at' date of that license has not passed the end of the expiration day.
        // Using copy()->endOfDay()->isFuture() to avoid mutating the original Carbon instance.
        return $this->license
            && $this->license->is_used
            && $this->license->expires_at
            && $this->license->expires_at->copy()->endOfDay()->isFuture();
    }
}
